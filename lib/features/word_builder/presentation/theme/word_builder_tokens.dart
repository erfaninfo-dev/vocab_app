...
abstract final class WbTokens {
  ...
  // Durations — presentation only (not physics balance timers)
  ...
  @Deprecated('Use dAmbient for chapter / ambient transitions')
  ...
  /// Lexend for Latin; Vazirmatn for Persian/Arabic glyphs (local assets).
