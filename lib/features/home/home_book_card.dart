                        ...
                        children: [
                          Flexible(
                            child: Align(
                              ...
                              child: _UnitCountPill(
                                isSoon: isSoon,
                                accents: accents,
                                scheme: scheme,
                                unitsValue: unitsValue,
                                l10n: l10n,
                                rtlUnitLine: rtlUnitLine,
                              ),
                            ),
                          ),
...
class _UnitCountPill extends StatelessWidget {
  const _UnitCountPill({
    required this.isSoon,
    required this.accents,
    required this.scheme,
    required this.unitsValue,
    required this.l10n,
    required this.rtlUnitLine,
  });

  final bool isSoon;
  final List<Color> accents;
  final ColorScheme scheme;
  final AsyncValue<List<UnitInfo>> unitsValue;
  final AppLocalizations l10n;
  final bool rtlUnitLine;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: isSoon
            ...
            : null,
        color: isSoon ? null : scheme.surface.withValues(alpha: 0.75),
        borderRadius: BorderRadius.circular(12),
        border: isSoon
        ...
        boxShadow: isSoon
            ? [
                BoxShadow(
                  color: accents.first.withValues(alpha: 0.22),
                  blurRadius: 16,
      ...
      child: Directionality(
        ...
        child: Row(
          ...
          children: [
            Icon(
              isSoon ? Icons.hourglass_empty_rounded : Icons.layers_rounded,
              size: 16,
            ...
            Text(
              ...
              style: Theme.of(context).textTheme.labelMedium?.copyWith(
                color: isSoon ? Colors.white : scheme.onSurfaceVariant,
                fontWeight: isSoon ? FontWeight.w900 : FontWeight.w600,
              ),
            ),
          ],
        ),
